...
class XORProblem(Scene):  
    def construct(self):  
        ...
        output_label_y = MathTex("y").move_to(xor_gate.output_point.get_center() + RIGHT * 0.5).set_color(output_color)
        self.play(Create(input_label_x1), Create(input_label_x2), Create(output_label_y))
